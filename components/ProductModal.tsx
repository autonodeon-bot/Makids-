      ...
      {product && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-white rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row z-10 max-h-[90vh] md:max-h-[600px]"
          >
            {/* Close Button */}
            <button 
              onClick={onClose}
            ...
            <div className="w-full md:w-1/2 h-64 md:h-full relative bg-slate-100">
              ...
              />
              {product.badge && (
                <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-md px-4 py-1.5 rounded-full text-sm font-bold shadow-sm text-brand-600">
            ...
            <div className="w-full md:w-1/2 p-8 overflow-y-auto flex flex-col">
              ...
              <div className="flex gap-2 mb-6">
                <span className="px-3 py-1 bg-brand-50 text-brand-700 text-xs font-bold uppercase rounded-full tracking-wider">
                  Опт от 5 шт.
                </span>
                <span className="px-3 py-1 bg-green-50 text-green-700 text-xs font-bold uppercase rounded-full tracking-wider">
                  В наличии
                </span>
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-slate-100">
                 <a 
                   href="#partner-form" 
                   onClick={onClose}
                   className="flex items-center justify-center w-full py-4 bg-brand-600 text-white rounded-xl font-bold shadow-lg shadow-brand-500/30 hover:bg-brand-700 transition-all active:scale-95"
                 >
